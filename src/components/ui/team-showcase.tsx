...
const DEFAULT_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    name: 'Osiris Balonga',
    role: 'LEAD FRONT-END',
    image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=400&h=400&q=80',
    social: { twitter: '#', linkedin: '#' },
  },
  {
    id: '4',
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        <span
          className={cn(
            'w-5 h-3 rounded-[5px] flex-shrink-0 transition-all duration-300',
            isActive ? 'bg-purple w-6' : 'bg-purple/20',
          )}
        />
        <span
          className={cn(
            'text-lg md:text-[22px] font-bold leading-none tracking-tight transition-colors duration-300',
          ...
          >
            {member.social?.twitter && (
              <a
                ...
                className="p-1 rounded text-purple/70 hover:text-purple hover:bg-purple/10 transition-all duration-150 hover:scale-110"
                title="X / Twitter"
              >
                <FaTwitter size={12} />
              </a>
      ...
      {/* Role */}
      <p className="mt-1.5 pl-[30px] text-[10px] md:text-[12px] font-semibold uppercase tracking-[0.2em] text-purple/70">
        {member.role}
      </p>
    </div>
  );
